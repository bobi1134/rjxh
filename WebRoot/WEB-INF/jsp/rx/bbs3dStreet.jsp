...
<head>
	...
	<!-- login css -->
	<style type="text/css">
		.login{width:1000px;height:500px;border:1px dotted #d5d5d5;}
	</style> 
</head>
    <body>
        <div id="container">
            <div id="header"><img src="${pageContext.request.contextPath}/rx/images/logo.jpg" alt="" />
                ...
                <form id="form1" action=''>
                    <p>
                        <input type="text" name="reachtext" class="text1" value="" />
                    </p>
                    <p>
            ...
            <!-- 登陆区代码 -->
            <div class="login">
            	<iframe src="http://360pano.sicau.edu.cn/yaan/" height="500" width="996"></iframe>
            </div>
            <!-- 登陆区代码 -->

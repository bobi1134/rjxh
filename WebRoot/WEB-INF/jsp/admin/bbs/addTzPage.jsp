...
<body>
	<div class="content_page">
		<form action="${pageContext.request.contextPath}/bbs/glyAddTz.do" method="post" id="addForm">
			<div style="margin:10px 0 10px 0;">
				标题：<input type="text" name="title" id="title" />
			</div>
			<textarea id="editorContainer" name="content">在这里输入内容！</textarea>

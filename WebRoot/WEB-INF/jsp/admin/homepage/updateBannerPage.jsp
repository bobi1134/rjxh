...
<head>
	<title> updateBannerPage.html </title>
...
<body>
	<div class="content_page">
		<div class="main">
			<fieldset>
				...
				<form action="${pageContext.request.contextPath}/homepage/updateBanner.do" method="post" id="updateForm" enctype="multipart/form-data">
					<label>ID：</label><input type="text" name="updateBanner.id" value="${updateBanner.id}" readonly="readonly" title="Banner的id不允许被修改" id="id"/>
					<label>图片：</label><input type="file" name="image" value="${updateBanner.image}" id="image" required/>
					<label>标题：</label><input type="text" name="updateBanner.title" value="${updateBanner.title}" id="title" required/>
					<div class="cz">
	...
	<script type="text/javascript">
		$("#image").css("width", parseInt($("#id").css("width"))+4);

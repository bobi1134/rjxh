...
<head>
	<title> addBannerPage.html </title>
	...
	<div class="content_page">
		<div class="main">
			<fieldset>
				...
				<form action="${pageContext.request.contextPath}/homepage/addBanner.do" method="post" id="addForm" enctype="multipart/form-data">

...
<head>
	<title> addSubDepartmentStyle.html </title>
...
<body>
	<div class="content_page">
		<div class="main">
			<fieldset>
				<legend style="brder:1px solid red;">添加子分支</legend>
				<form action="${pageContext.request.contextPath}/bmfc/addSubZc.do" method="post" id="addForm">
					<input type="hidden" name="style.belong" value="${zc}"/>
					<label>分支名：</label><input type="text" name="style.category" value="${style.category}" id="category" required/>
					<label style="float:left">简介：</label><textarea name="style.introduce" rows="5" style="float:left;margin-top:11px;" required id="introduce">${style.introduce}</textarea>
					<div class="cz">

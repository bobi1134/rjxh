...
<head>
	...
	<style type="text/css">
		*{margin:0px;padding:0px;}
		...
		textarea,select{font-family:"微软雅黑";}
...
<body>
	<div class="content_page">
		<div class="main">
			<fieldset>
				<legend style="brder:1px solid red;">添加标题</legend>
				<form action="${pageContext.request.contextPath}/lxwm/addBt.do" method="post" id="addForm">
					<label>分类：</label><select name="belongId" required>
											<s:iterator value="contactParents">
												<option value="<s:property value="id"/>"><s:property value="category"/> </option>
											</s:iterator>
										</select>
	...
	<script type="text/javascript">
		$("textarea").css("width", parseInt($("#title").css("width"))+4).css("max-width", parseInt($("#title").css("width"))+4);
		$("select").css("width", parseInt($("#title").css("width"))+4).css("max-width", parseInt($("#title").css("width"))+4);

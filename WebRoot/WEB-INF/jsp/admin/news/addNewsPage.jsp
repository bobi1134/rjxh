...
<body>
	<div class="content_page">
		<form action="${pageContext.request.contextPath}/zxdt/addNews.do" method="post" id="addForm">
			<div style="margin:10px 0 10px 0;">
				标题：<input type="text" name="new_.title" id="title" />
			</div>
			<textarea id="editorContainer" name="new_.content">在这里输入内容！</textarea>

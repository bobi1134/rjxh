...
<head>
	<title> addTrainactivePage.html </title>
...
<body>
	<div class="content_page">
		<form action="${pageContext.request.contextPath}/trainactive/addTrainactive.do" method="post" id="addForm">
			<div style="margin:10px 0 10px 0;">
				标题：<input type="text" name="trainActive.title" id="title" />
			</div>
			<textarea id="editorContainer" name="trainActive.content">在这里输入内容！</textarea>

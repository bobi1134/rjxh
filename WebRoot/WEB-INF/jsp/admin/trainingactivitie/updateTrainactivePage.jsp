...
<head>
	<title> updateTrainactivePage.html </title>
...
<body>
	<div class="content_page">
		<form action="${pageContext.request.contextPath}/trainactive/updateTrainactive.do" method="post" id="updateForm">
			<input type="hidden" name="trainActive.id" value="${trainActive.id}"/>
			<div style="margin:10px 0 10px 0;">
				标题：<input type="text" name="trainActive.title" value="${trainActive.title}" id="title" />
			</div>
			<textarea id="editorContainer" name="trainActive.content">${trainActive.content}</textarea>

...
<head>
	<title> addImgInfoPage.html </title>
...
<body>
	<div class="content_page">
		<div class="main">
			<fieldset>
				<legend style="brder:1px solid red;">添加照片墙</legend>
				<form action="${pageContext.request.contextPath}/xhjj/addImgInfo.do" method="post" id="addForm" enctype="multipart/form-data">
					<label>标题：</label><input type="text" name="imgtitle" id="imgtitle" required/>
	...
	<script type="text/javascript">
		$("#image").css("width", parseInt($("#imgtitle").css("width"))+4);

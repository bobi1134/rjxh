		...
		<table width="100%" border="1" style="border:#c2c6cc 1px solid; border-collapse:collapse; table-layout:fixed;">
			...
			<s:iterator value="associationIntroduces">
				<tr>
					...
					<td align="center"><a href="${pageContext.request.contextPath}/xhjj/updateBaseInfoPage.do?id=${id}"><img src="${pageContext.request.contextPath}/admin/images/update.gif" width="13" height="13" style="vertical-align:middle;" title="更改"/></a></td>
					<td align="center"><a href="${pageContext.request.contextPath}/xhjj/deleteBaseInfo.do?id=${id}" onclick="return confirm('你确定要删除？')"><img src="${pageContext.request.contextPath}/admin/images/delete.png" width="13" height="13" style="vertical-align:middle;" title="删除"/></a></td>
				</tr>
			</s:iterator>
		</table>

...
<head>
	<title> addHotAnswerPage.html </title>
...
<body>
	<div class="content_page">
		<form action="${pageContext.request.contextPath}/hotanswer/addHotAnswer.do" method="post" id="addForm">
			<div style="margin:10px 0 10px 0;">
				标题：<input type="text" name="hotAnswer.title" id="title" />
			</div>
			<textarea id="editorContainer" name="hotAnswer.content">在这里输入内容！</textarea>

...
<head>
	<title> updateHotAnswerPage.html </title>
...
<body>
	<div class="content_page">
		<form action="${pageContext.request.contextPath}/hotanswer/updateHotAnswer.do" method="post" id="updateForm">
			<input type="hidden" name="hotAnswer.id" value="${hotAnswer.id}"/>
			<div style="margin:10px 0 10px 0;">
				标题：<input type="text" name="hotAnswer.title" value="${hotAnswer.title}" id="title" />
			</div>
			<textarea id="editorContainer" name="hotAnswer.content">${hotAnswer.content}</textarea>
